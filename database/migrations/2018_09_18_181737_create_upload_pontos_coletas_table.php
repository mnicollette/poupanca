...
class CreateUploadPontosColetasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Upload_pontos_coletas", 'upload_pontos_coletas', 'file', 'fa-upload', [
    ...
    {
        if (Schema::hasTable('upload_pontos_coletas')) {
            Schema::drop('upload_pontos_coletas');
        }
    }
}
