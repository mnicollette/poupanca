...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $mapa->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Mapas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/mapas/'.$mapa->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Mapas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.mapas.destroy', $mapa->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/mapas') }}" data-toggle="tooltip" data-placement="right" title="Back to Mapas"><i class="fa fa-chevron-left"></i></a></li>
