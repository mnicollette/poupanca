...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body" style="padding: 0 15px 0;">
				<div class="box-body">
					...
					<div class="form-group col-xs-4">
						...
						<input class="form-control" placeholder="Enter Cidade" data-rule-maxlength="80" id="cidade" name="cidade" type="text" value=""  readonly="readonly">
					</div>
					<div class="form-group col-xs-4">
						<label for="estado">Estado:</label>
						<input class="form-control" placeholder="Enter Estado" data-rule-maxlength="2" id="estado" name="estado" type="text" value=""  readonly="readonly">
					</div>
					<div class="form-group col-xs-4">
						<label for="CEP">CEP:</label>
						<input class="form-control" placeholder="Enter CEP" data-rule-maxlength="9" id="CEP" name="CEP" type="text" value=""  readonly="readonly">
					</div>
					<div class="form-group col-xs-6">
					...
					<div class="form-group col-xs-12" style="height:200px" id="map-canvas">
          ...
          places.forEach(function(place) {
            ...
            var icon = {
              ...
              scaledSize: new google.maps.Size(25, 25)
						...
						if(places[0].address_components.length == 6){
							$('#cidade').val(places[0].address_components[3].long_name);
							$('#estado').val(places[0].address_components[3].short_name);
							$('#CEP').val(places[0].address_components[5].long_name);
						}else{
							$('#cidade').val(places[0].address_components[4].long_name);
							$('#estado').val(places[0].address_components[4].short_name);
							$('#CEP').val(places[0].address_components[6].long_name);
						}
